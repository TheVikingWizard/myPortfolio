...
export default function SocialIcons({
  ...
  return (
    <div className={`${isMenu ? "rounded-l-full rounded-r-full px-2 py-2 bg-[#111827]" : ""} flex ${layoutDirection} ${containerClass} mb-4`}>
      <a href="https://www.linkedin.com/in/rijit-singh-a74438182/" target="_blank" rel="noopener noreferrer">
        <img
          ...
          alt="LinkedIn"
          title="LinkedIn"
          className={`${finalIconSize} rounded-full ${border ? "border-6 border-[#111827]" : undefined} hover:scale-125 transition-transform duration-200 ease-in-out`}
        />
      </a>
